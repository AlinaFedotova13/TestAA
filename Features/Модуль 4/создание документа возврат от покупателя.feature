...
@ExportScenarios
@IgnoreOnCIMainBuild
Функционал: создание документа Возврат от покупателя

Как Менеджер по закупкам я хочу
корректно составлять документ Заказ покупателя
чтобы данные были верные для меня и моих покупателей

Контекст:
	Дано Я запускаю сценарий открытия TestClient или подключаю уже существующий

Сценарий: создание документа Заказа покупателя
